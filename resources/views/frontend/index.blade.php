                        ...
                        <div class="col-lg-4 mb-4 order-0">
                            <div class="card">
                                <div class=" align-items-end ">
                                    <div class="col-sm-12">
                                        <div class="card-body">
                                            <h5 class="card-title text-primary">Birthday/Anniversary🎉</h5>
                                            <p class="mb-4">
                                                You have done <span class="fw-bold">72%</span> re sales today. Check
                                                your new badge in
                                                your profile.
                                            </p>
                        ...
                        <div class="col-lg-4 mb-4 order-0">
                            <div class="card">
                                <div class=" align-items-end ">
                                    <div class="col-sm-12">
                                        <div class="card-body">
                                            <h5 class="card-title text-primary">Total Attendance/Absent</h5>
                                            <p class="mb-4">
                                                You have done <span class="fw-bold">72%</span> re sales today. Check
                                                your new badge in
                                                your profile.
                                ...
                                <div class="col-lg-6 col-md-12 col-6 mb-4">
                                    <div class="card" style="padding-bottom: 7px;">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title text-nowrap mb-1">10,679</h3>
                                            {{--  <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i>
                                                +28.42%</small>  --}}
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                            <div class="card">
                                <div class="row row-bordered g-0">
                                    <div class="col-md-8">
                                        <h5 class="card-header m-0 me-2 pb-3">Total Attendance/Absent</h5>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="text-center fw-semibold pt-3 mb-2">62% Total Present Today</div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title text-nowrap mb-2">1,456</h3>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <span class="fw-semibold d-block mb-1">Total Leave</span>
                        ...
                        <div class="col-md-6 col-lg-4 order-2 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <ul class="p-0 m-0">
                                        <li class="d-flex mb-4 pb-1">
                                            <div id="name_element" class="avatar flex-shrink-0 me-3"
                                                style="width: 3.375rem;">
                                                {{--  <img src="../assets/img/icons/unicons/paypal.png" alt="User"
                                                    class="rounded" />  --}}
                                                <h6 class="mb-0">Sachin</h6>
                                            </div>
                                            <div
                                                class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            <div class="avatar flex-shrink-0 me-3"style="width: 3.375rem;">
                                                {{--  <img src="../assets/img/icons/unicons/wallet.png" alt="User"
                                                    class="rounded" />  --}}
                                                <h6 class="mb-0">Rakesh</h6>
                                            </div>
                                            <div
                                                class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            ...
                                            <div
                                                ...
                                                <div class="user-progress d-flex align-items-center gap-1">
                                                    <h6 class="mb-0"> flutter Developer</h6>

                                                </div>
                                            </div>
                                        </li>
                                        <li class="d-flex mb-4 pb-1">
                                            <div class="avatar flex-shrink-0 me-3" style="width: 4.375rem;">
                                                {{--  <img src="../assets/img/icons/unicons/wallet.png" alt="User"
                                                    class="rounded" />  --}}
